from PersonalDataApi.datapoints.models import CategoryTypes, DatapointV2, RawData, MetaData
...
class ProcessRawData:
    ...
    def speech(self, info, source, category, label, starttime, stoptime=None,
        ...
        if uploaded_audio is None:
            ...
            try:
                text += transcribe_file(uploaded_audio, profile.language) if (uploaded_audio != None) else None 
